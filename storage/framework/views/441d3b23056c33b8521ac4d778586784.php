        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl w-full mx-auto sm:px-6 lg:px-8 space-y-4 py-4">
                ...
                <div class="w-full rounded-md bg-white border-2 border-gray-600 p-4 min-h-[720px] h-full text-gray-600">
                    <textarea class="min-h-[720px] h-full w-full outline-none" spellcheck="false"><?php echo e($content); ?></textarea>
                </div>
            </div>
        </div>
    </body>
</html><?php /**PATH C:\Users\Majas\Documents\School\MG\3.Semestris\laravel-vue\resources\views/writer.blade.php ENDPATH**/ ?>